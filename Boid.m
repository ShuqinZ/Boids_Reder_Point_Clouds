...
classdef Boid < handle
    ...
    methods
        ...
        function obj = move(obj, boids)
            ...
            % to the rules.
            obj.velocity(1) = obj.velocity(1) + (v1x * obj.priority(1) + v2x * obj.priority(2) + v3x * obj.priority(3) + v4x * obj.priority(4)) / 2;
            obj.velocity(2) = obj.velocity(2) + (v1y * obj.priority(1) + v2y * obj.priority(2) + v3y * obj.priority(3) + v4y * obj.priority(4)) / 2;
            obj.velocity(3) = obj.velocity(3) + (v1z * obj.priority(1) + v2z * obj.priority(2) + v3z * obj.priority(3) + v4z * obj.priority(4)) / 2;

            obj.limit_speed();
            obj.coord(1) = obj.coord(1) + obj.velocity(1);
            obj.coord(2) = obj.coord(2) + obj.velocity(2);
            obj.coord(3) = obj.coord(3) + obj.velocity(3);
